...
for iN in range(Ns.size):
  ...
  timeSpread[iN] = timer() - timeSpread[iN]
  ...
  timeSolve[iN] = timer() - timeSolve[iN]
  ...
  timeInterp[iN] = timer() - timeInterp[iN]
  ...
  gridGen.Clean()
  particlesGen.Clean()
  timeClean[iN] = timer() - timeClean[iN]
  print(timeInterp)
...
plt.title('Timing DP solver stages for $L_{xy} = 140$, $L_z = 17$, $N_z = 30$', fontsize=20)
